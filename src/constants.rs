//! libcurl constants definition
//! Based on the const.py from curl_cffi project
...
pub enum CurlOpt {
  ...
  // @taskylizard/libcurl specific options
...
// Impersonate browser type constants
#[derive(Debug)]
#[napi(string_enum)]
